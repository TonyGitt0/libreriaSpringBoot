 ...
 */
/**
 * Modella l'oggetto LibroDTO composto da un titolo,trama,data di uscita,
 * una lista di autori associati al libro, una locazione in cui è
 * posizionato il libro e la casa editrice legata al libro
 */
